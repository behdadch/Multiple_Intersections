...
<sc version="201801" id="1" name="Constant Time Signal" frequency="1" steps="0" defaultIntergreenMatrix="0" interstagesUsingMinDurations="true" checkSum="702020379">
  <signaldisplays>
  ...
  <sgs>
    <sg id="1" name="V1" defaultSignalSequence="7">
      <defaultDurations>
    ...
    <sg id="2" name="V2" defaultSignalSequence="7">
      <defaultDurations>
        <defaultDuration display="1" duration="1000" />
        <defaultDuration display="3" duration="5000" />
        <defaultDuration display="4" duration="3000" />
  ...
  <intergreenmatrices />
  <progs>
    <prog id="1" cycletime="29000" switchpoint="0" offset="0" intergreens="0" fitness="0.000000" vehicleCount="0" name="Signal program 1">
      <sgs>
